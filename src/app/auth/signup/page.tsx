...
import { AlertCircle, Mail, CheckCircle2, ArrowLeft, Check, X, Eye, EyeOff } from "lucide-react";
        ...
        <Card className="rounded-xl p-10 sm:p-12" style={{
          ...
          <CardContent className="px-0 pb-0">
            <form onSubmit={handleSignUp} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    style={{ color: '#6a6d78' }}
                    onMouseEnter={(e) => e.currentTarget.style.color = '#b0b2bc'}
                    onMouseLeave={(e) => e.currentTarget.style.color = '#6a6d78'}
              ...
              >
                {loading ? "Requesting account..." : "Request account"}
              </Button>
            </form>
          </CardContent>
        </Card>
