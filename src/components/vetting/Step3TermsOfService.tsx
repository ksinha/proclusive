...
export default function Step3TermsOfService({ onComplete, onBack, initialAccepted }: Step3Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-[24px] font-semibold text-gray-900 mb-2">Terms of Service</h2>
      ...
      <Card className="bg-white">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-[18px] font-semibold text-gray-900">Proclusive Platform Terms of Service</CardTitle>
          </div>
          <CardDescription className="text-[13px] text-gray-600">Last Updated: January 2025</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="max-h-96 overflow-y-auto pr-4 space-y-4 border border-gray-200 rounded-lg p-4 bg-gray-50">
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">1. Acceptance of Terms</h4>
            ...
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">2. Membership & Verification</h4>
              <p className="text-[13px] text-gray-700">
                Proclusive operates a curated, high-trust network. All members must:
              </p>
              <ul className="text-[13px] text-gray-700 space-y-1 list-disc list-inside ml-4">
            ...
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">3. Referral System</h4>
              <p className="text-[13px] text-gray-700">
            ...
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">4. Code of Conduct</h4>
              <p className="text-[13px] text-gray-700">
                All members must:
              </p>
              <ul className="text-[13px] text-gray-700 space-y-1 list-disc list-inside ml-4">
            ...
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">5. Data Privacy & Security</h4>
              <p className="text-[13px] text-gray-700">
            ...
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">6. Limitation of Liability</h4>
              <p className="text-[13px] text-gray-700">
            ...
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">7. Termination</h4>
              <p className="text-[13px] text-gray-700">
            ...
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">8. Governing Law</h4>
              <p className="text-[13px] text-gray-700">
            ...
            <div className="space-y-2">
              <h4 className="text-[14px] font-semibold text-gray-900">9. Changes to Terms</h4>
              <p className="text-[13px] text-gray-700">
      ...
      <Card className="bg-white border-blue-100">
        <CardContent className="pt-6">
          <div className="flex items-start gap-3">
            ...
            />
            <Label htmlFor="accept-terms" className="text-[14px] text-gray-700 cursor-pointer">
      ...
      <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
        ...
        <Button type="submit" variant="default" disabled={!accepted} className="h-10 text-[14px]">
          Continue to Review
        </Button>
      </div>
    </form>
